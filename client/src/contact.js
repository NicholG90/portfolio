...
const ContactForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    let details = {
      ...
      destinationEmail: "portfolio@gourlay.me"
    };
    let response = await fetch("https://nodemailer.gourlay.me", {
      method: "POST",
      headers: {
      ...
      <div className="wrapper">
        ...
        <div className={styles.contactInner}>
          <div className={styles.contactInformation}>
            ...
            <a href="mailto:portfolio@gourlay.me" className={styles.emailSection}>
