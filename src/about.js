      ...
      <div className="wrapper">
          <div className={styles.aboutText}>
            ...
            <div className={styles.logos}>
              <a href={'https://github.com/NicholG90'} target="_blank" rel="noreferrer">
              ...
              <a href={'https://www.linkedin.com/in/nickgourlay/'} target="_blank" rel="noreferrer">
